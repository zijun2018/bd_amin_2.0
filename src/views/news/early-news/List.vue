...
<template>
  <div class="news-early-news-list">
    ...
    <div class="early-news-list-header">
      ...
      <a-button icon="plus"
                type="primary"
                @click="jumpToEarlyNewsAdd">新建</a-button>
      <!-- Part1-2: 标题输入 -->
      ...
      <a-locale-provider :locale="zh_CN">
        <a-table :columns="columns"
          ...
          <template slot="action" slot-scope="text, record">
            ...
            <a-button @click="jumpToEarlyNewsEdit(record.key)"
                      ghost
                      size="small"
...
<script>
  ...
  export default {
    ...
    methods: {
      getEarlyNewsData() {
        return getAdminMorningMarketList({
       ...
       */
      jumpToEarlyNewsAdd() {
        this.$router.push({ name: 'early_news_add' });
      },

      /**
       * 跳转到早盘文章编辑页
       */
      jumpToEarlyNewsEdit(key) {
      ...
      onDelete (key) {
        ...
        return getAdminMorningMarketDel({
          params,
          success: () => {
